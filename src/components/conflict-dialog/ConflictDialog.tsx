    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent dividers>
        <Typography variant="body1" gutterBottom>
          Found {conflicts.length} conflict(s) in your data. Please choose how
          to resolve them:
        </Typography>
        ...
        {conflicts.map((conflict, index) => (
          <Box key={index} sx={{ mb: 3 }}>
            <Typography variant="subtitle1" sx={{ mb: 1 }}>
              {conflict.type === "group" ? "Group" : "Widget"} conflict:{" "}
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 6 }}>
              <Button
                variant={
                  resolution.action === "apply-all" ? "contained" : "outlined"
                }
                fullWidth
            ...
            <Grid size={{ xs: 6 }}>
              <Button
                variant={
                  resolution.action === "clone" ? "contained" : "outlined"
                }
                fullWidth
          ...
          {resolution.action === "clone" && (
            <Box sx={{ mt: 2 }}>
              <TextField
                ...
                helperText={
                  !resolution.newCode ? "Please enter a new code" : ""
                }
              />
            </Box>
          )}
